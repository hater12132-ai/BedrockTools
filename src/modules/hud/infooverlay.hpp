...
private:
    ...
    bool m_blur = true;
    float m_backgroundOpacity = 0.72f;
    float m_glowOpacity = 0.16f;
    float m_iconOpacity = 0.92f;
    unsigned int m_panelColor = 0x171126;   // dark purple glass
    unsigned int m_accentColor = 0x9A6CFF;  // main purple
    unsigned int m_textColor = 0xF7F3FF;
